import { Context, Service, type Plugin } from '@monotykamary/cordis'
import type { Dict } from '@monotykamary/cosmokit'
import { ModuleLoader, type ModuleJob, type ResolveResult } from '@monotykamary/cordis-plugin-loader'
import type { Include } from '@monotykamary/cordis-plugin-include'
import { FSWatcher, watch, type ChokidarOptions } from 'chokidar'
import { dirname, relative, resolve } from 'node:path'
import { realpath, stat } from 'node:fs/promises'
import { handleError } from './error.ts'
import type {} from '@monotykamary/cordis-plugin-timer'
