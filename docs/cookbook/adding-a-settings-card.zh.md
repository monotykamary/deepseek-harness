...
```jsonc
{
  ...
  "dsh": { "client": { "platform": "web", "inject": ["@monotykamary/dsh-client-ui-settings-plugins"] } }
}
```
...
export default clientBundle('@monotykamary/dsh-client-my-plugin', ['lib/types/index.js', 'lib/types/invariant.js'])
```
