...
def test_default_config_is_shipped_with_the_package() -> None:
    ...
    assert "@monotykamary/dsh-agent-spine-demo" in config
    assert "@monotykamary/dsh-session-persistence-jsonl" in config
    assert "@monotykamary/dsh-session-checkpoint-policy" in config
