...
import { parseSessionLog } from '@monotykamary/dsh-llm-replay'
import type { SessionEvent, SessionId } from '@monotykamary/dsh-session'
import type {} from '@monotykamary/dsh-goal'
import {
...
const PACKAGE_FILES: Readonly<Record<string, string>> = {
  ...
  'packages/client/ui-conversation/package.json': '{"name":"@monotykamary/dsh-client-ui-conversation"}\n',
  ...
  'packages/context/session-reference/package.json': '{"name":"@monotykamary/dsh-session-reference"}\n',
  ...
  'packages/llm/token-meter/package.json': '{"name":"@monotykamary/dsh-token-meter"}\n',
  ...
  'packages/skill/skill-filesystem/package.json': '{"name":"@monotykamary/dsh-skill-filesystem"}\n',
