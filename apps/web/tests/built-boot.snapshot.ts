...
it('boots the built plugin graph and renders a fixture session end to end', async () => {
  ...
  for (const plugin of ['@monotykamary/dsh-client-ui-layout', '@monotykamary/dsh-client-ui-sidebar', '@monotykamary/dsh-client-ui-conversation', '@monotykamary/dsh-client-ui-tool']) {
