...
import type { WebBootEntry } from '@monotykamary/dsh-client-modules/client'
...
const PLUGINS: readonly (WebBootEntry & { bundlePath: string })[] = [
  { id: '@monotykamary/dsh-typert-registry', bundlePath: 'packages/typert/registry/lib/client.js', url: '/plugins/typert-registry.js', rev: 'fx', inject: [], immediately: true },
  { id: '@monotykamary/dsh-client-connection', bundlePath: 'packages/client/connection/lib/client.js', url: '/plugins/connection.js', rev: 'fx', inject: [], immediately: true },
  { id: '@monotykamary/dsh-api-gateway', bundlePath: 'packages/api/gateway/lib/client.js', url: '/plugins/api-gateway.js', rev: 'fx', inject: ['@monotykamary/dsh-typert-registry', '@monotykamary/dsh-client-connection'], immediately: true },
  { id: '@monotykamary/dsh-api-remotes', bundlePath: 'packages/api/remotes/lib/client.js', url: '/plugins/api-remotes.js', rev: 'fx', inject: ['@monotykamary/dsh-api-gateway'], immediately: true },
  ...
  { id: '@monotykamary/dsh-client-ui-settings', bundlePath: 'packages/client/ui-settings/lib/client.js', url: '/plugins/ui-settings.js', rev: 'fx', inject: ['@monotykamary/dsh-client-connection', '@monotykamary/dsh-client-runtime', '@monotykamary/dsh-api-remotes'], immediately: true },
  { id: '@monotykamary/dsh-client-runtime', bundlePath: 'packages/client/runtime/lib/client.js', url: '/plugins/runtime.js', rev: 'fx', inject: ['@monotykamary/dsh-client-connection', '@monotykamary/dsh-typert-registry', '@monotykamary/dsh-api-gateway'], immediately: true },
  ...
  { id: '@monotykamary/dsh-client-ui-workflow-run', bundlePath: 'packages/client/ui-workflow-run/lib/client.js', url: '/plugins/ui-workflow-run.js', rev: 'fx', inject: ['@monotykamary/dsh-client-locale', '@monotykamary/dsh-client-runtime', '@monotykamary/dsh-client-ui-conversation'] },
  {
    id: '@monotykamary/dsh-client-ui-workspace',
    ...
    inject: [
      ...
      '@monotykamary/dsh-client-ui-sidebar',
    ],
  },
  { id: '@monotykamary/dsh-session-log-export', bundlePath: 'packages/session-query/session-log-export/lib/client.js', url: '/plugins/session-log-download.js', rev: 'fx', inject: ['@monotykamary/dsh-client-ui-commands', '@monotykamary/dsh-client-ui-conversation'] },
  { id: '@monotykamary/dsh-client-ui-trajectory', bundlePath: 'packages/client/ui-trajectory/lib/client.js', url: '/plugins/ui-trajectory.js', rev: 'fx', inject: ['@monotykamary/dsh-client-ui-conversation'] },
]
