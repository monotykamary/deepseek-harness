...
import { bootInjections, orderByModuleGraph } from '@monotykamary/dsh-client-modules'
import type { ClientModuleLoaderTarget, WebBootEntry } from '@monotykamary/dsh-client-modules/client'
...
const appBoot = await import(pathToFileURL(webBundleResolver.resolve('@monotykamary/dsh-app-boot')).href) as unknown as BootComposition
...
export function mountAssembledApp(search = '?fixture'): void {
  ...
  for (const id of ['@monotykamary/dsh-client-modules', '@monotykamary/dsh-client-runtime']) {
