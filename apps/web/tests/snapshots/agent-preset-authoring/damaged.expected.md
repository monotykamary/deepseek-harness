  ...
  - list:
    - listitem:
      - 'button "加载失败: broken-yaml" [disabled]':
        ...
        - code: broken-yaml
      - 'button "查看路径: broken-yaml"': 查看路径
      - 'button "复制: broken-yaml" [disabled]': 预设加载失败，不能复制
      - 'button "删除: broken-yaml"': 删除
    - listitem:
      - 'button "加载失败: 幽灵预设" [disabled]':
        ...
        - code: ghost
      - 'button "查看路径: 幽灵预设"': 查看路径
      - 'button "复制: 幽灵预设" [disabled]': 预设加载失败，不能复制
      - 'button "删除: 幽灵预设"': 删除
