...
function manifest(): string {
  ...
  mkdirSync(join(root, 'node_modules', 'dsh-tool-repair'), { recursive: true })
  mkdirSync(join(root, 'node_modules', 'dsh-multiprovider'), { recursive: true })
  ...
  writeFileSync(join(root, 'package.json'), JSON.stringify({
    name: '@monotykamary/dsh', version: '1.0.0', dependencies: { 'dsh-tool-repair': '1.5.0', 'dsh-multiprovider': '1.6.0', 'dsh-fabric': '2.0.0', 'dsh-fovea': '3.0.0', 'dsh-factory': '4.0.0' },
  }))
  writeFileSync(join(root, 'node_modules', 'dsh-tool-repair', 'package.json'), JSON.stringify({ version: '1.5.0' }))
  writeFileSync(join(root, 'node_modules', 'dsh-multiprovider', 'package.json'), JSON.stringify({ version: '1.6.0' }))
