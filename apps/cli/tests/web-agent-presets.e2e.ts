...
import { boot, healProfilesModuleFallback, loadOverlayPatches, loadProfile } from '@monotykamary/dsh-app-boot'
...
async function bootWeb(
  ...
  // Bun's package link for only the selected products; their own production
