/**
 * Package-owned invariant companion for `@monotykamary/dsh-tool-jobs`.
 * @module @monotykamary/dsh-tool-jobs/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-tool-jobs'
