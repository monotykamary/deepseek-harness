/**
 * Package-owned invariant companion for `@monotykamary/dsh-mcp-client`.
 * @module @monotykamary/dsh-mcp-client/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-mcp-client'
