/**
 * Package-owned invariant companion for `@monotykamary/dsh-tmux-context`.
 * @module @monotykamary/dsh-tmux-context/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-tmux-context'
