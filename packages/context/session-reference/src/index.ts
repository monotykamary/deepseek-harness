 ...
 *
 * @module @monotykamary/dsh-session-reference
 */
...
import { createUserMessage, freezeMessage } from '@monotykamary/dsh-llm'
import type { ContentBlock, UserMessage } from '@monotykamary/dsh-llm'
import type { SessionId } from '@monotykamary/dsh-session'
import type { SessionSurfaceSnapshot, SessionTitleObservationResult } from '@monotykamary/dsh-session-query'
import {
