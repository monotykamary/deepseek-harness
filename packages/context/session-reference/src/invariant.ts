/**
 * Package-owned invariant companion for `@monotykamary/dsh-session-reference`.
 * @module @monotykamary/dsh-session-reference/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-session-reference'
