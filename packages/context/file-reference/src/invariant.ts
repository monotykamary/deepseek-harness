/**
 * Package-owned invariant companion for `@monotykamary/dsh-file-reference`.
 * @module @monotykamary/dsh-file-reference/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-file-reference'
