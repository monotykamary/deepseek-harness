# `@monotykamary/dsh-file-reference`
...
Indirectly, through `@monotykamary/dsh-file-reference-local`, which conditionally contributes this package's stable file-reference guidance.
