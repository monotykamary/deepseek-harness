/**
 * Package-owned invariant companion for `@monotykamary/dsh-file-reference-local`.
 * @module @monotykamary/dsh-file-reference-local/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-file-reference-local'
