 ...
 *
 * @module @monotykamary/dsh-file-reference-local
 */
...
} from '@monotykamary/dsh-file-reference'
...
export { FILE_REFERENCE_PROMPT } from '@monotykamary/dsh-file-reference'
export { activeAtToken, formatFileMention } from '@monotykamary/dsh-file-reference/grammar'
