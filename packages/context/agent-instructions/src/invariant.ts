/**
 * Package-owned invariant companion for `@monotykamary/dsh-agent-instructions`.
 * @module @monotykamary/dsh-agent-instructions/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-agent-instructions'
