...
import {
  ...
  parseProcStat,
} from '@monotykamary/dsh-subprocess-local/src/process-inspector.ts'
import type { ProcessInspectorInternals } from '@monotykamary/dsh-subprocess-local/src/process-inspector.ts'
import { WindowsProcessInspector } from '@monotykamary/dsh-subprocess-local/src/windows-inspector.ts'
