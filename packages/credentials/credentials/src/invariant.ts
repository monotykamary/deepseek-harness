/**
 * Package-owned invariant companion for `@monotykamary/dsh-credentials`.
 * @module @monotykamary/dsh-credentials/invariant
 */

import type { Context } from '@monotykamary/cordis'
import type { InvariantFailure, InvariantInstaller } from '@monotykamary/dsh-invariants'

const PACKAGE_NAME = '@monotykamary/dsh-credentials'
