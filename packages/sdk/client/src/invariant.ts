/**
 * Package-owned invariant companion for `@monotykamary/dsh-sdk-client`.
 * @module @monotykamary/dsh-sdk-client/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-sdk-client'
