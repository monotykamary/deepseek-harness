 ...
 *
 * @module @monotykamary/dsh-sdk-jsonrpc-server/server
 */

import type { Context } from '@monotykamary/cordis'
import { resolve } from 'node:path'
import type { Agent, AgentHandle } from '@monotykamary/dsh-agent'
import { createUserMessage } from '@monotykamary/dsh-llm'
import { carrierKeyOf, type Scoped } from '@monotykamary/dsh-scope'
import { SessionId } from '@monotykamary/dsh-session'
import type SubagentRuntime from '@monotykamary/dsh-subagent'
import type { SubagentRunEndInfo } from '@monotykamary/dsh-subagent'
...
} from '@monotykamary/dsh-sdk-protocol'
...
export class HarnessSdkJsonRpcServer {
  ...
  private async createSession(sessionId: string): Promise<SessionRecord> {
    ...
    // (@monotykamary/dsh-agent-presets README, "Composing a child agent").
