/**
 * Package-owned invariant companion for `@monotykamary/dsh-sdk-jsonrpc-server`.
 * @module @monotykamary/dsh-sdk-jsonrpc-server/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-sdk-jsonrpc-server'
