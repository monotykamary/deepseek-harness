/**
 * Package-owned invariant companion for `@monotykamary/dsh-sdk-protocol`.
 * @module @monotykamary/dsh-sdk-protocol/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-sdk-protocol'
