 ...
 * plugin (`@monotykamary/dsh-sdk-jsonrpc-server`) and SDK clients share these shapes;
 * `serverInfo.name` stays the wire-stable `deepseek-harness-sdk-runtime`.
 *
 * @module @monotykamary/dsh-sdk-protocol/types
 */

import type { ContentBlock } from '@monotykamary/dsh-llm'
import type { SessionEvent } from '@monotykamary/dsh-session'
import type { SubagentStopReason } from '@monotykamary/dsh-subagent'
