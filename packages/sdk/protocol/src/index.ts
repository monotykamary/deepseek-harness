 ...
 * (`@monotykamary/dsh-sdk-jsonrpc-server`) serves this protocol; SDK clients
 * (`@monotykamary/dsh-sdk-client`, the Python SDK) drive it.
 *
 * @module @monotykamary/dsh-sdk-protocol
 */
