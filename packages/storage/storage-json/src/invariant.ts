/**
 * Package-owned invariant companion for `@monotykamary/dsh-storage-json`.
 * @module @monotykamary/dsh-storage-json/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-storage-json'
