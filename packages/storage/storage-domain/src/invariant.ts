/**
 * Package-owned invariant companion for `@monotykamary/dsh-storage-domain`: every
 ...
 * @module @monotykamary/dsh-storage-domain/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-storage-domain'
