/**
 * Package-owned invariant companion for `@monotykamary/dsh-output-retention`.
 * @module @monotykamary/dsh-output-retention/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-output-retention'
