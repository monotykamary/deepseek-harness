/**
 * Package-owned invariant companion for `@monotykamary/dsh-launch-environment`.
 * @module @monotykamary/dsh-launch-environment/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-launch-environment'
