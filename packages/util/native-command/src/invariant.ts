/**
 * Package-owned invariant companion for `@monotykamary/dsh-native-command`.
 * @module @monotykamary/dsh-native-command/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-native-command'
