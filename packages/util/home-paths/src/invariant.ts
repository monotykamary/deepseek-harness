/**
 * Package-owned invariant companion for `@monotykamary/dsh-home-paths`.
 * @module @monotykamary/dsh-home-paths/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-home-paths'
