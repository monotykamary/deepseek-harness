/**
 * Package-owned invariant companion for `@monotykamary/dsh-atomic-write`.
 * @module @monotykamary/dsh-atomic-write/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-atomic-write'
