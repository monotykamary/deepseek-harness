 ...
 *
 * @module @monotykamary/dsh-tool-bash/render
 */

import type { ShellProcessRead, ShellRunResult, ShellSandboxInfo, CollectedOutput } from '@monotykamary/dsh-shell'
import type { SandboxMode } from '@monotykamary/dsh-sandbox'
import { escalationHintMarker, sandboxDenialMarker } from '@monotykamary/dsh-sandbox'
 ...
 * rendering story, owned by `@monotykamary/dsh-shell` so `dsh-tool-pwsh` reuses
 ...
 */
export { parseExitStatus, type ParsedExitStatus } from '@monotykamary/dsh-shell'
