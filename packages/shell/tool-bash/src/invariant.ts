/**
 * Package-owned invariant companion for `@monotykamary/dsh-tool-bash`.
 * @module @monotykamary/dsh-tool-bash/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-tool-bash'
