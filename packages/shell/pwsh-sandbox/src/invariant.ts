/**
 * Package-owned invariant companion for `@monotykamary/dsh-pwsh-sandbox`.
 * @module @monotykamary/dsh-pwsh-sandbox/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-pwsh-sandbox'
