/**
 * Package-owned invariant companion for `@monotykamary/dsh-tool-pwsh-persistent`.
 * @module @monotykamary/dsh-tool-pwsh-persistent/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-tool-pwsh-persistent'
