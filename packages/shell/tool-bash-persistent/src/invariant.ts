/**
 * Package-owned invariant companion for `@monotykamary/dsh-tool-bash-persistent`.
 * @module @monotykamary/dsh-tool-bash-persistent/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-tool-bash-persistent'
