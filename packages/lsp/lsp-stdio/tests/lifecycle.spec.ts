...
import Lsp, { type LspProvider, type LspQueryRequest, type LspQueryResult } from '@monotykamary/dsh-lsp'
import { deadline } from '@monotykamary/dsh-timeout'
...
import type { LspLocalServerConfig } from '@monotykamary/dsh-lsp-stdio'
