/**
 * Package-owned invariant companion for `@monotykamary/dsh-lsp-stdio`.
 * @module @monotykamary/dsh-lsp-stdio/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-lsp-stdio'
