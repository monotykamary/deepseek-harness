/**
 * Package-owned invariant companion for `@monotykamary/dsh-user-questions`.
 * @module @monotykamary/dsh-user-questions/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-user-questions'
