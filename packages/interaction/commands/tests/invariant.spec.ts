...
import * as CommandInvariant from '@monotykamary/dsh-commands/invariant'
...
import { CommandId } from '@monotykamary/dsh-commands'
...
describe('command lifecycle invariants', () => {
  ...
  it.each([-1, 1.5, 1])('rejects invalid or non-prior sourceEventSeq %s', async (sourceEventSeq) => {
    ...
    expect(() => {
      ...
      code: 'INVARIANT',
      packageName: '@monotykamary/dsh-commands',
    }))
  })
