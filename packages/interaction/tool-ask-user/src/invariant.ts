/**
 * Package-owned invariant companion for `@monotykamary/dsh-tool-ask-user`.
 * @module @monotykamary/dsh-tool-ask-user/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-tool-ask-user'
