/** Package-owned permission-preset event invariants. @module @monotykamary/dsh-permission-presets/invariant */
...
const PACKAGE_NAME = '@monotykamary/dsh-permission-presets'
