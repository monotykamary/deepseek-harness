...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  {
    ...
    occupants: [
      'client-ui-terminal BottomTerminal',
    ],
  ...
  },
  {
    ...
    hookContext: '',
    slotInject: '',
    declaredBy: 'an entry in \'workbench.surface\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'root',
    summary: 'Optional product welcome content below the Hero headline.',
    doc: 'Optional product welcome content below the Hero headline. The owner\ndistinguishes the no-session landing page from an ordinary blank draft.',
    registerOptions: [],
    ownerProps: [
    ...
    declaredBy: 'an entry in \'conversation\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      'client-ui-brand-official Welcome',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'conversation.session.header\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      'client-ui-conversation WorkbenchToggle id \'workbench-toggle\'',
      'client-ui-terminal BottomTerminalToggle id \'bottom-terminal\'',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-session-title SessionTitleRow id \'session-title\'',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-settings-updates UpdateSettings id \'updates\'',
    ],
    replaceRisk: 'none',
  ...
  {
    key: 'settings.trigger.badge',
    kind: 'single',
    scope: 'root',
    summary: 'Optional status content rendered after the Settings trigger label.',
    doc: 'Optional status content rendered after the Settings trigger label.',
    registerOptions: [],
    ownerProps: [
    ...
    hookContext: '',
    slotInject: '',
    declaredBy: 'an entry in \'settings.trigger\' (client-ui-settings-general), so it exists while that entry is mounted',
    occupants: [
      'client-ui-settings-updates UpdateBadge',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    kind: 'list',
    scope: 'session',
    summary: 'One independently registered right-panel surface.',
    doc: 'One independently registered right-panel surface. Entries are available\nto the workbench launcher and render only when their tab is active.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
    ...
    occupants: [
      ...
      'client-ui-deliverables ChangesPanel',
      'client-ui-files FilesPanel',
      'client-ui-terminal WorkbenchTerminal',
    ],
    replaceRisk: 'none',
