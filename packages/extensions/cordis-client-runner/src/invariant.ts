/**
 * Package-owned invariant companion for `@monotykamary/dsh-cordis-client-runner`.
 * @module @monotykamary/dsh-cordis-client-runner/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-cordis-client-runner'
