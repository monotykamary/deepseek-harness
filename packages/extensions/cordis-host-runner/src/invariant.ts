/**
 * Package-owned invariant companion for `@monotykamary/dsh-cordis-host-runner`.
 * @module @monotykamary/dsh-cordis-host-runner/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-cordis-host-runner'
