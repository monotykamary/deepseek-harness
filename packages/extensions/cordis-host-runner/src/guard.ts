 ...
 * @module @monotykamary/dsh-cordis-host-runner/guard
 */

import { Context } from '@monotykamary/cordis'
import type { Plugin } from '@monotykamary/cordis'
import { scopeOf } from '@monotykamary/dsh-scope'
import { assertSupportedJsonSchema, defineTool } from '@monotykamary/dsh-tools'
...
function sandboxContext(ctx: Context, reportFailure: (error: Error) => void): Context {
  ...
  // (`@monotykamary/dsh-cordis-client-runner`, whose CTX_VERBS names this one its
