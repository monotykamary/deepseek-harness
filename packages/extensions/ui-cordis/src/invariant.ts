/**
 * Package-owned invariant companion for `@monotykamary/dsh-client-ui-cordis`.
 * @module @monotykamary/dsh-client-ui-cordis/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-client-ui-cordis'
