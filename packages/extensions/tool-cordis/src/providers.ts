...
import { HOST_BUILTIN_INSPECTION } from '@monotykamary/dsh-cordis-host-runner'
import type { HostCordisInspectProviderRegistration } from '@monotykamary/dsh-cordis-host-runner'
