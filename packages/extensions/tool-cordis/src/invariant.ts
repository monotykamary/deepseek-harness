/**
 * Package-owned invariant companion for `@monotykamary/dsh-tool-cordis`.
 * @module @monotykamary/dsh-tool-cordis/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-tool-cordis'
