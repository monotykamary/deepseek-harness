 ...
 * @module @monotykamary/dsh-tool-terminal
 */
...
import { TerminalSessionId } from '@monotykamary/dsh-terminal'
import type { TerminalSendResult, TerminalSessionId as TerminalSessionIdType, TerminalSignal } from '@monotykamary/dsh-terminal'
  ...
  ctx.tools.register(defineTool({
    ...
    async execute(args: SendArgs, exec) {
      ...
      if (args.run_in_background === true) {
        ...
        if (jobs === undefined) throw new Error('background terminal sends require @monotykamary/dsh-jobs and @monotykamary/dsh-tool-jobs')
