/**
 * Package-owned invariant companion for `@monotykamary/dsh-tool-terminal`.
 * @module @monotykamary/dsh-tool-terminal/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-tool-terminal'
