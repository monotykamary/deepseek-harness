 ...
 * @module @monotykamary/dsh-tool-ralph
 */
...
import type { SubagentProvider } from '@monotykamary/dsh-subagent'
import { defineTool } from '@monotykamary/dsh-tools'
import type { ToolCallView, ToolResultView } from '@monotykamary/dsh-tools'
import type { WorkflowResult, WorkflowRun } from '@monotykamary/dsh-workflow'
