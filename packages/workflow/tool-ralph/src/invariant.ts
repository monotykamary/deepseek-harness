/**
 * Package-owned invariant companion for `@monotykamary/dsh-tool-ralph`.
 * @module @monotykamary/dsh-tool-ralph/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-tool-ralph'
