/**
 * Package-owned invariant companion for `@monotykamary/dsh-workflow-worker-thread`.
 * @module @monotykamary/dsh-workflow-worker-thread/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-workflow-worker-thread'
