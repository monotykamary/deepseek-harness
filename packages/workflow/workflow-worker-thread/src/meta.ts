 ...
 * @module @monotykamary/dsh-workflow-worker-thread/meta
 */

import { WorkflowError } from '@monotykamary/dsh-workflow'
import type { WorkflowMeta, WorkflowPhase } from '@monotykamary/dsh-workflow'
