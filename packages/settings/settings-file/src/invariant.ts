/**
 * Package-owned invariant companion for `@monotykamary/dsh-settings-file`.
 * @module @monotykamary/dsh-settings-file/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-settings-file'
 ...
 * tests; the in-process commit relation is owned by `@monotykamary/dsh-settings`.
 */
