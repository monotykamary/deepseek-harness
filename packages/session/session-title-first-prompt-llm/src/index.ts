...
/**
 * Register the first-prompt model provider under the user-settings opt-in.
...
export function apply(ctx: Context, config: Config): void {
  registerSessionTitleLlmSettingsProvider(ctx, SESSION_TITLE_LLM_SETTINGS_NAMESPACE, config, name, 'first-prompt', (messages) => {
