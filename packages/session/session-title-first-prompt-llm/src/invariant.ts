/**
 * Package-owned invariant companion for `@monotykamary/dsh-session-title-first-prompt-llm`.
 * @module @monotykamary/dsh-session-title-first-prompt-llm/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-session-title-first-prompt-llm'
