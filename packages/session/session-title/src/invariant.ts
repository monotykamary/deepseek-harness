/**
 * Package-owned invariant companion for `@monotykamary/dsh-session-title`.
 * @module @monotykamary/dsh-session-title/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-session-title'
