 ...
 * @module @monotykamary/dsh-session-title
 */

import { Context, FiberState, Service, type Fiber } from '@monotykamary/cordis'
import z from '@monotykamary/schemastery'
import { z as zod } from 'zod'
import type { Branded } from '@monotykamary/dsh-brand'
import { assertNever, deepFreeze, isAgentLoopRequest } from '@monotykamary/dsh-llm'
import type { GenerateOptions } from '@monotykamary/dsh-llm'
import type {
  Session,
  SessionEvent,
