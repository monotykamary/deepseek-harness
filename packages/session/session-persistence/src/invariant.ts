/**
 * Package-owned invariant companion for `@monotykamary/dsh-session-persistence`.
 * @module @monotykamary/dsh-session-persistence/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-session-persistence'
