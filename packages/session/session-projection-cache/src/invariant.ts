/**
 * Package-owned invariant companion for `@monotykamary/dsh-session-projection-cache`.
 * @module @monotykamary/dsh-session-projection-cache/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-session-projection-cache'
