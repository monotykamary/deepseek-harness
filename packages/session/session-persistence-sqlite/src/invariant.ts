/**
 * Package-owned invariant companion for `@monotykamary/dsh-session-persistence-sqlite`.
 * @module @monotykamary/dsh-session-persistence-sqlite/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-session-persistence-sqlite'
