/**
 * Package-owned invariant companion for `@monotykamary/dsh-session-telemetry`.
 * @module @monotykamary/dsh-session-telemetry/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-session-telemetry'
