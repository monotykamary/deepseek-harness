/**
 * Package-owned invariant companion for `@monotykamary/dsh-session-projection`.
 * @module @monotykamary/dsh-session-projection/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-session-projection'
