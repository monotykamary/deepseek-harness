/**
 * Package-owned invariant companion for `@monotykamary/dsh-session-stats`.
 * @module @monotykamary/dsh-session-stats/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-session-stats'
