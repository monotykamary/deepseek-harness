/**
 * Package-owned invariant companion for `@monotykamary/dsh-session-telemetry-otel`.
 * @module @monotykamary/dsh-session-telemetry-otel/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-session-telemetry-otel'
