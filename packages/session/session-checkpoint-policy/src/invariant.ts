/**
 * Package-owned invariant companion for `@monotykamary/dsh-session-checkpoint-policy`.
 * @module @monotykamary/dsh-session-checkpoint-policy/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-session-checkpoint-policy'
