/** Package-owned goal-round prompt invariants. @module @monotykamary/dsh-goal-round-driver/invariant */

import { isDeepStrictEqual } from 'node:util'
import type { Context } from '@monotykamary/cordis'
import { foldGoal, type FoldedGoal, type GoalMessageSource, type GoalView } from '@monotykamary/dsh-goal'
...
const PACKAGE_NAME = '@monotykamary/dsh-goal-round-driver'
