/**
 * Package-owned invariant companion for `@monotykamary/dsh-command-goal`.
 * @module @monotykamary/dsh-command-goal/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-command-goal'
