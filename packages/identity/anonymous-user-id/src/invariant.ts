/**
 * Package-owned invariant companion for `@monotykamary/dsh-anonymous-user-id`.
 * @module @monotykamary/dsh-anonymous-user-id/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-anonymous-user-id'
