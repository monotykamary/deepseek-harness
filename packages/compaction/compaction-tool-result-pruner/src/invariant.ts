/**
 * Package-owned invariant companion for `@monotykamary/dsh-compaction-tool-result-pruner`.
 * @module @monotykamary/dsh-compaction-tool-result-pruner/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-compaction-tool-result-pruner'
