 ...
 *
 * The seam itself lives in `@monotykamary/dsh-compaction`, which re-exports these
 ...
 *
 * @module @monotykamary/dsh-compaction/checkpoint
 */

import type { MessageSource } from '@monotykamary/dsh-llm/message'
