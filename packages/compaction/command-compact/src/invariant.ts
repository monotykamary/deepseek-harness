/**
 * Package-owned invariant companion for `@monotykamary/dsh-command-compact`.
 * @module @monotykamary/dsh-command-compact/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-command-compact'
