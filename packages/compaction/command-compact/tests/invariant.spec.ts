...
import * as invariant from '@monotykamary/dsh-command-compact/invariant'
...
describe('command-compact invariant companion', () => {
  it('registers the package-owned no-op installer', async () => {
    ...
    expect(register).toHaveBeenCalledWith('@monotykamary/dsh-command-compact', expect.any(Function))
    expect(() => {
