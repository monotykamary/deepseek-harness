/**
 * Package-owned invariant companion for `@monotykamary/dsh-api-gateway`.
 * @module @monotykamary/dsh-api-gateway/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-api-gateway'
