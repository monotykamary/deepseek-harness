/**
 * Package-owned invariant companion for `@monotykamary/dsh-tool-str-replace-editor`.
 * @module @monotykamary/dsh-tool-str-replace-editor/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-tool-str-replace-editor'
