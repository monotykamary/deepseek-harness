 ...
 * `@monotykamary/dsh-fs` Service Definition. It extends `LocalFileSystem` so all
 ...
 * stays `ctx.shell`'s job (`@monotykamary/dsh-bash-sandbox`). This mirrors the
 ...
 * escalation retry lives in the tool layer (`@monotykamary/dsh-tool-fs`),
 * exactly as bash's does.
 *
 * @module @monotykamary/dsh-fs-sandbox
 */

import { Context } from '@monotykamary/cordis'
import { LocalFileSystem } from '@monotykamary/dsh-fs-local'
import type { Config as LocalConfig } from '@monotykamary/dsh-fs-local'
import { FsError } from '@monotykamary/dsh-fs'
import type { FsEditOutcome, FsEditRequest, FsTarget, FsVersion, FsWriteIntent, FsWriteOutcome } from '@monotykamary/dsh-fs'
import { writableRoots } from '@monotykamary/dsh-sandbox'
