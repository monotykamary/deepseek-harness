/**
 * Package-owned invariant companion for `@monotykamary/dsh-fs-sandbox`.
 * @module @monotykamary/dsh-fs-sandbox/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-fs-sandbox'
