/**
 * Package-owned invariant companion for `@monotykamary/dsh-tool-fs-search`.
 * @module @monotykamary/dsh-tool-fs-search/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-tool-fs-search'
