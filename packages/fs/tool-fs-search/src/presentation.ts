 ...
 * model-facing render consumes ({@link module:@monotykamary/dsh-tool-fs-search/search-core}
 ...
 *
 * @module @monotykamary/dsh-tool-fs-search/presentation
 */
 ...
 * ({@link module:@monotykamary/dsh-tool-fs-search/grep} `formatGrepMatches`), so
