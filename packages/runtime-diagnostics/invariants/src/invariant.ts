/**
 * Package-owned invariant companion for `@monotykamary/dsh-invariants`.
 * @module @monotykamary/dsh-invariants/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-invariants'
