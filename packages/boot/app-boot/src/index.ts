 ...
 * @module @monotykamary/dsh-app-boot
 */
...
import { Context, type FiberState } from '@monotykamary/cordis'
import Loader, { type Entry, type EntryOptions } from '@monotykamary/cordis-plugin-loader'
import Include, { applyEntryPatches, entryListSchema, type PatchOptions } from '@monotykamary/cordis-plugin-include'
import Group from '@monotykamary/cordis-plugin-group'
import { dshHomePath, resolveDshHome } from '@monotykamary/dsh-home-paths'
import { createLaunchEnvironmentSnapshot, type LaunchEnvironmentSnapshot } from '@monotykamary/dsh-launch-environment'
import type {} from '@monotykamary/cordis-plugin-hmr'
 ...
 * entries (`@monotykamary/cordis-plugin-include`'s `PatchOptions`): id-targeted config
 ...
 * `@monotykamary/cordis-plugin-include` `PatchOptions` (id-targeted config overrides and
...
export async function mountRootInclude(
  ...
  // preset living outside this workspace cannot resolve `@monotykamary/cordis-plugin-group`
