/** Package-owned invariant companion for `@monotykamary/dsh-attachment-local`. @module @monotykamary/dsh-attachment-local/invariant */

/* jscpd:ignore-start */
import type { Context } from '@monotykamary/cordis'
import type { InvariantInstaller } from '@monotykamary/dsh-invariants'

const PACKAGE_NAME = '@monotykamary/dsh-attachment-local'
