/**
 * Package-owned invariant companion for `@monotykamary/dsh-tool-skill`.
 * @module @monotykamary/dsh-tool-skill/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-tool-skill'
