/**
 * Package-owned invariant companion for `@monotykamary/dsh-skill-badge`.
 * @module @monotykamary/dsh-skill-badge/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-skill-badge'
