/**
 * Package-owned invariant companion for `@monotykamary/dsh-subprocess-e2b`.
 * @module @monotykamary/dsh-subprocess-e2b/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-subprocess-e2b'
