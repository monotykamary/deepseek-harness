...
import { bindScopeParent, createScope } from '@monotykamary/dsh-scope'
...
import type { PreToolDecision, ToolDefinition, ToolExecution, ToolExecutionInput, ToolExecutionToken } from '@monotykamary/dsh-tools'
