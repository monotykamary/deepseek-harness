 ...
 * @module @monotykamary/dsh-agent-loop/invariant
 */

import type { Context } from '@monotykamary/cordis'
import { isAgentLoopRequest, type GenerateOptions } from '@monotykamary/dsh-llm'
import type { InvariantFailure, InvariantInstaller } from '@monotykamary/dsh-invariants'
import { foldRequestHeader } from '@monotykamary/dsh-session'

const PACKAGE_NAME = '@monotykamary/dsh-agent-loop'
