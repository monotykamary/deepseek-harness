 ...
 * @module @monotykamary/dsh-agent-loop/runtime-context
 */

import { createUserMessage } from '@monotykamary/dsh-llm'
import type { ContextSnapshotSection } from '@monotykamary/dsh-llm'
import type { Session, UserMessage } from '@monotykamary/dsh-session'
import { isReplacementSurfaceEvent } from '@monotykamary/dsh-session'
import type { Context } from '@monotykamary/cordis'

const SOURCE = '@monotykamary/dsh-system-prompt'
