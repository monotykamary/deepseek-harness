/** Package-owned scoped-dispatch invariants. @module @monotykamary/dsh-scope/invariant */

import type { Context } from '@monotykamary/cordis'
import type { InvariantInstaller } from '@monotykamary/dsh-invariants'
import { carrierKeyOf, isScopeCarrier } from '@monotykamary/dsh-scope'
import { scopedSubjectResolverFor } from './scoped-events.generated.ts'

const PACKAGE_NAME = '@monotykamary/dsh-scope'
