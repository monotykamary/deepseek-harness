/**
 * Package-owned invariant companion for `@monotykamary/dsh-agent-tool-presentation`.
 * @module @monotykamary/dsh-agent-tool-presentation/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-agent-tool-presentation'
