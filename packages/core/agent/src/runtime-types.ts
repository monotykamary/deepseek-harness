 ...
 * turn/step boundaries remain `@monotykamary/dsh-session` events.
 *
 * @module @monotykamary/dsh-agent
 */

import type { Context } from '@monotykamary/cordis'
import type { Scoped } from '@monotykamary/dsh-scope'
import type { LlmCallConfig, LlmFailure, ResolvedRetryPolicy } from '@monotykamary/dsh-llm'
import type { AgentCancelCause, Session, SessionId, UserMessage } from '@monotykamary/dsh-session'
export type { AgentCancelCause } from '@monotykamary/dsh-session'
import type { Inbox } from './inbox.ts'
import type { InboxTarget } from './types.ts'
import type {} from '@monotykamary/dsh-system-prompt'
declare module '@monotykamary/dsh-system-prompt' {
...
declare module '@monotykamary/cordis' {
  interface Events {
     ...
     * Scope-filtered dispatch (`@monotykamary/dsh-scope`): agent-scoped listeners receive only that agent.
     * @mode emit
     */
