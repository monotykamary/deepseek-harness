...
import { Context, FiberState, getTraceable, Service, symbols } from '@monotykamary/cordis'
 ...
 * (`@monotykamary/dsh-agent-loop`), registered via {@link setFactory}.
 *
  ...
  constructor(ctx: Context) {
    ...
    ctx.inject(['typert'], (typeCtx) => {
      typeCtx.typert.lookups.register('agent', {
        parameter: 'agent',
        wire: 'agentId',
        hostTypeSymbol: '@monotykamary/dsh-agent#Agent',
