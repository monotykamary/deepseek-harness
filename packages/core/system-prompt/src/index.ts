 ...
 *
 * @module @monotykamary/dsh-system-prompt
 */

import { Context, Service } from '@monotykamary/cordis'
import z from '@monotykamary/schemastery'
import { AnonymousEntries, NamedEntries, ScopedLayers, scopeTarget } from '@monotykamary/dsh-scope'
import type { ScopeKey, ScopeLayer, Scoped } from '@monotykamary/dsh-scope'
import type { ContextSnapshotSection, ToolSchema } from '@monotykamary/dsh-llm'
...
declare module '@monotykamary/cordis' {
  ...
  interface Events {
     ...
     * Scope-filtered dispatch (`@monotykamary/dsh-scope`): scoped listeners
