/**
 * Package-owned invariant companion for `@monotykamary/dsh-host-webserver`.
 * @module @monotykamary/dsh-host-webserver/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-host-webserver'
