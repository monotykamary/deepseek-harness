...
import type { Agent, AgentFactory } from '@monotykamary/dsh-agent'
...
import type { DirectoryPickerCapability } from '@monotykamary/dsh-host-directory-picker'
import WorkspaceRegistry from '@monotykamary/dsh-workspace'
import type { HostFrame, WorkspaceId } from '@monotykamary/dsh-host-apiproxy/api'
import type { RpcRequest, RpcResponse } from '@monotykamary/dsh-host-apiproxy/api/rpc'
