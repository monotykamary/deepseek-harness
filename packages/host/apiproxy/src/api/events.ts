...
import type { AskUserQuestionItem } from '@monotykamary/dsh-user-questions/types'
import type { ApprovalOutcome, ApprovalRequestId } from '@monotykamary/dsh-user-approval/types'
import type { Message } from '@monotykamary/dsh-llm/types'
import type { MessageId } from '@monotykamary/dsh-llm/brand'
import type { CallId } from '@monotykamary/dsh-llm/brand'
import type { JsonValue, SessionEvent, SessionId } from '@monotykamary/dsh-session/types'
import type { ToolCallView, ToolResultView } from '@monotykamary/dsh-tools/presentation'
...
export type HostFrame =
   ...
   * owned by `@monotykamary/dsh-api-remotes` (`API_REMOTE_FORWARDED_EVENTS`),
