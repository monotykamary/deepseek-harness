...
import { z } from 'zod'
import type { SessionEvent, SessionId } from '@monotykamary/dsh-session/types'
...
import type { AttachmentIdType, ImageAttachmentLimits, ImageAttachmentRef } from '@monotykamary/dsh-attachment'
...
export const sessionUpdateQueueRequestSchema = z.object({
  ...
  action: z.discriminatedUnion('kind', [
    ...
    z.object({ kind: z.literal('move'), direction: z.union([z.literal('earlier'), z.literal('later')]) }),
