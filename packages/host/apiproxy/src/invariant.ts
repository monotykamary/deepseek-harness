/**
 * Package-owned invariant companion for `@monotykamary/dsh-host-apiproxy`.
 * @module @monotykamary/dsh-host-apiproxy/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-host-apiproxy'
