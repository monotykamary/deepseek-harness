/** Package-owned invariant companion for the directory-picker seam. @module @monotykamary/dsh-host-directory-picker/invariant */

import type { Context } from '@monotykamary/cordis'
import type { InvariantInstaller } from '@monotykamary/dsh-invariants'

const PACKAGE_NAME = '@monotykamary/dsh-host-directory-picker'
