...
| [`workspace-files/`](workspace-files/README.md) | Session-authorized workspace listing, reading, and guarded editing | Remote `workspaceFiles/list`, `workspaceFiles/read`, `workspaceFiles/write` |
