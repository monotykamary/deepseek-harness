 ...
 * @module @monotykamary/dsh-host-directory-picker-auto
 */
...
export const BACKEND_PACKAGES: Record<DirectoryPickerBackendKind, string> = {
  native: '@monotykamary/dsh-host-directory-picker-native',
  browse: '@monotykamary/dsh-host-directory-picker-browse',
}
...
export const SURFACE_PACKAGES: Record<DirectoryPickerBackendKind, string> = {
  native: '@monotykamary/dsh-client-ui-directory-picker-native',
  browse: '@monotykamary/dsh-client-ui-directory-picker-browse',
}
