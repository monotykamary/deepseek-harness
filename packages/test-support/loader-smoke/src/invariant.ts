/**
 * Package-owned invariant companion for `@monotykamary/dsh-loader-smoke`.
 * @module @monotykamary/dsh-loader-smoke/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-loader-smoke'
