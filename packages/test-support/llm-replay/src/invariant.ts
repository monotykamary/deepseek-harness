/**
 * Package-owned invariant companion for `@monotykamary/dsh-llm-replay`.
 * @module @monotykamary/dsh-llm-replay/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-llm-replay'
