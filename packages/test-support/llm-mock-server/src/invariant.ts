/**
 * Package-owned invariant companion for `@monotykamary/dsh-llm-mock-server`.
 * @module @monotykamary/dsh-llm-mock-server/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-llm-mock-server'
