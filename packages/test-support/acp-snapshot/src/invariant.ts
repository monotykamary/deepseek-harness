/**
 * Package-owned invariant companion for `@monotykamary/dsh-acp-snapshot`.
 * @module @monotykamary/dsh-acp-snapshot/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-acp-snapshot'
