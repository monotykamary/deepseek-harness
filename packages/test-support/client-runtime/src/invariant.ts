/**
 * Package-owned invariant companion for `@monotykamary/dsh-client-test-runtime`.
 * @module @monotykamary/dsh-client-test-runtime/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-client-test-runtime'
