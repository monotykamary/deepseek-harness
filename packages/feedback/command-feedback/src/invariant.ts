/**
 * Package-owned invariant companion for `@monotykamary/dsh-command-feedback`.
 * @module @monotykamary/dsh-command-feedback/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-command-feedback'
