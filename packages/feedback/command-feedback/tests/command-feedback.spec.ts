...
import type { Agent, AgentStatus } from '@monotykamary/dsh-agent'
import CommandRuntime from '@monotykamary/dsh-commands'
import SessionStore, { foldSurface, Session, SessionId } from '@monotykamary/dsh-session'
import { SessionTelemetryBackend, type SessionTelemetrySharingStatus } from '@monotykamary/dsh-session-telemetry'
import * as commandFeedback from '@monotykamary/dsh-command-feedback'
...
vi.mock('@monotykamary/dsh-anonymous-user-id', () => ({
...
describe('@monotykamary/dsh-command-feedback registration', () => {
