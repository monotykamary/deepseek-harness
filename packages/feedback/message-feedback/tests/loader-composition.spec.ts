...
async function loadComposition(configPath: string): Promise<Context> {
  ...
  const modules = new Map<string, unknown>([
    ...
    ['@monotykamary/dsh-session-persistence-jsonl', JsonlSessionPersistence],
    ['@monotykamary/dsh-storage', Storage],
    ['@monotykamary/dsh-storage-json', StorageJson],
    ['@monotykamary/dsh-storage-domain', StorageDomain],
    ['@monotykamary/dsh-message-feedback', MessageFeedbackService],
  ])
  ctx.loader.internal = {
    version: 'v2',
