/**
 * Package-owned invariant companion for `@monotykamary/dsh-web-search-deepseek`.
 * @module @monotykamary/dsh-web-search-deepseek/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-web-search-deepseek'
