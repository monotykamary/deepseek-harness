 ...
 * `@monotykamary/dsh-tool-web`. Requests carry no browser cookies or ambient credentials.
 *
 ...
 * @module @monotykamary/dsh-web-fetch-http/provider
 */

import { WebError } from '@monotykamary/dsh-web'
import type { WebFetchBody, WebFetchProvider, WebFetchRequest, WebFetchResult } from '@monotykamary/dsh-web'
