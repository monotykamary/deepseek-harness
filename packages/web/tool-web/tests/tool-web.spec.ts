...
import type { WebSearchProvider, WebSearchResult } from '@monotykamary/dsh-web'
...
} from '@monotykamary/dsh-tool-web'
...
async function mountTools(opts: {
  ...
  fetchProvider?: import('@monotykamary/dsh-web').WebFetchProvider
