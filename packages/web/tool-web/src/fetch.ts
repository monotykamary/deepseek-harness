...
import type { GenericCallView, JsonValue, ToolResult, WebFetchResultView } from '@monotykamary/dsh-tools'
import type { WebFetchBody, WebFetchResult } from '@monotykamary/dsh-web'
 ...
 * `@monotykamary/dsh-tool-call-timeout-policy`, not a model argument.
 *
 ...
 *   `ToolDefinition.timeoutMs` for `@monotykamary/dsh-tool-call-timeout-policy` to enforce.
