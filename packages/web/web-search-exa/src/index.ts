/**
 * `@monotykamary/dsh-web-search-exa`: registers an Exa-backed `WebSearchProvider`
 ...
 * seam's provider registry, exactly as `@monotykamary/dsh-llm-deepseek`
 * registers an adapter into `ctx.llm`. The key is owned by `@monotykamary/dsh-web`.
 *
 * @module @monotykamary/dsh-web-search-exa
 */
