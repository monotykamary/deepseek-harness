...
import { LAUNCHER_FAILURE_EXIT } from '@monotykamary/node-addon-landlock-run'
import { SANDBOX_UNAVAILABLE, SandboxUnavailableError } from '@monotykamary/dsh-sandbox'
import type { SandboxPolicy } from '@monotykamary/dsh-sandbox'
import {
  LocalSandboxProvider,
} from '@monotykamary/dsh-sandbox-local'
import type { Config } from '@monotykamary/dsh-sandbox-local'
...
describe('the platform chains', () => {
  ...
  // live in @monotykamary/dsh-sandbox-windows-acl/tests/provider-chain.spec.ts
