 ...
 *
 * @module @monotykamary/dsh-sandbox-local/profiles
 */

import { grantArgs as landlockGrantArgs } from '@monotykamary/node-addon-landlock-run'
 ...
 * (`@monotykamary/dsh-fs-sandbox`) can never drift apart.
