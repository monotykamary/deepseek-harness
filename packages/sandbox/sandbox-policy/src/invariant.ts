/** Package-owned session-event invariants for sandbox policy. @module @monotykamary/dsh-sandbox-policy/invariant */
...
const PACKAGE_NAME = '@monotykamary/dsh-sandbox-policy'
