/**
 * Package-owned invariant companion for `@monotykamary/dsh-sandbox-windows-acl`.
 * @module @monotykamary/dsh-sandbox-windows-acl/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-sandbox-windows-acl'
