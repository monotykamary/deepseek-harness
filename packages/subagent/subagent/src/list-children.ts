 ...
 *
 * @module @monotykamary/dsh-subagent
 */

import type { Context } from '@monotykamary/cordis'
import type { Session, SessionEvent, SessionHeader, SessionId } from '@monotykamary/dsh-session'
import type { SessionPersistence } from '@monotykamary/dsh-session-persistence'
import type { SessionProjectionRegistry } from '@monotykamary/dsh-session-projection'
import type { SessionProjectionCache } from '@monotykamary/dsh-session-projection-cache'
...
async function prepareListing(
  ...
  if (projections === undefined) {
    throw new SubagentError(
      'listing subagents requires the sessionProjections registry (load @monotykamary/dsh-session-projection)',
  ...
  if (sessions === undefined) {
    throw new SubagentError(
      'listing subagents requires the session store (load @monotykamary/dsh-session)',
