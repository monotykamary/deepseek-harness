 ...
 * (`@monotykamary/dsh-subagent-spawn-in-process`, `-fork`, `-acp`) and the model-facing
 * consumer (`@monotykamary/dsh-tool-subagent`) are separate packages.
 *
...
import { assertObjectJsonSchema } from '@monotykamary/dsh-tools'
import type { ContentBlock, MessageId } from '@monotykamary/dsh-llm'
