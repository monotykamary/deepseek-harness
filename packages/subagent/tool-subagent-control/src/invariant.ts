/**
 * Package-owned invariant companion for `@monotykamary/dsh-tool-subagent-control`.
 * @module @monotykamary/dsh-tool-subagent-control/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-tool-subagent-control'
