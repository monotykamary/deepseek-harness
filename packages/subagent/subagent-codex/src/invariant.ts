/**
 * Package-owned invariant companion for `@monotykamary/dsh-subagent-codex`.
 * @module @monotykamary/dsh-subagent-codex/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-subagent-codex'
