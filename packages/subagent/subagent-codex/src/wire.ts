 ...
 *
 * @module @monotykamary/dsh-subagent-codex/wire
 */

import type { Readable, Writable } from 'node:stream'
import type { ContentBlock } from '@monotykamary/dsh-llm'
import type { SubagentResult } from '@monotykamary/dsh-subagent'
import { JsonRpcLineTransport } from '@monotykamary/dsh-sdk-protocol'
