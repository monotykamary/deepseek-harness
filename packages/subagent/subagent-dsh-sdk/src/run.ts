 ...
 * runtime over stdio JSON-RPC through `@monotykamary/dsh-sdk-client` and owns
 * cancellation and quiescent disposal. Structure mirrors the ACP backend
 * (`@monotykamary/dsh-subagent-acp`): publish after the child handshake,
 ...
 *
 * @module @monotykamary/dsh-subagent-dsh-sdk/run
 */

import { randomUUID } from 'node:crypto'
import { DeepSeekHarness, type HarnessNotification } from '@monotykamary/dsh-sdk-client'
import type { ContentBlock } from '@monotykamary/dsh-llm'
import { SessionId, type SessionEvent, type TurnEndReason } from '@monotykamary/dsh-session'
import type { SubagentResult, SubagentRun, SubagentStartRequest, SubagentStopReason } from '@monotykamary/dsh-subagent'
import { AssistantOutputFold, settleRunResult, subprocessRunHandle } from '@monotykamary/dsh-subagent'
