/**
 * Package-owned invariant companion for `@monotykamary/dsh-subagent-dsh-sdk`.
 * @module @monotykamary/dsh-subagent-dsh-sdk/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-subagent-dsh-sdk'
