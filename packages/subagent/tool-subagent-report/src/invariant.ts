/**
 * Package-owned invariant companion for `@monotykamary/dsh-tool-subagent-report`.
 * @module @monotykamary/dsh-tool-subagent-report/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-tool-subagent-report'
