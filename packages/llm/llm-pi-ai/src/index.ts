 ...
 * ```
 *
 * @module @monotykamary/dsh-llm-pi-ai
 */

import type { Context } from '@monotykamary/cordis'
import { launchEnvironmentOf } from '@monotykamary/dsh-launch-environment'
import { assertUsableApiKey, LlmError } from '@monotykamary/dsh-llm'
import type { AdapterRegistrationHandle, DirectoryRegistrationHandle, LlmConfigurableProvider } from '@monotykamary/dsh-llm'
