/**
 * Package-owned invariant companion for `@monotykamary/dsh-token-meter`.
 * @module @monotykamary/dsh-token-meter/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-token-meter'
