...
import type { ImageAttachmentRef, ImageMediaType, RequestImageAttachment } from '@monotykamary/dsh-attachment'
import { createUserMessage, CallId, ReasoningEffortId, createMessage } from '@monotykamary/dsh-llm'
import type { ContentBlock, GenerateOptions, Message } from '@monotykamary/dsh-llm'
import {
  serializeMessages,
