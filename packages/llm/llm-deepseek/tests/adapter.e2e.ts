...
import LlmRuntime, { createUserMessage, CallId, ReasoningEffortId, createMessage } from '@monotykamary/dsh-llm'
...
import type { Config } from '@monotykamary/dsh-llm-deepseek'
