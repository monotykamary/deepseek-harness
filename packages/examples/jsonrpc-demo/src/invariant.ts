/**
 * Package-owned invariant companion for `@monotykamary/dsh-sdk-jsonrpc-demo`.
 * @module @monotykamary/dsh-sdk-jsonrpc-demo/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-sdk-jsonrpc-demo'
