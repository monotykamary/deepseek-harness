 ...
 * ({@link @monotykamary/dsh-agent-spine-demo}), JSONL session persistence, and
 * the {@link @monotykamary/dsh-acp} bridge. The app owns those plugins through one
 ...
 * @module @monotykamary/dsh-acp-demo
 */

import type { Context } from '@monotykamary/cordis'
import { join } from 'node:path'
import z from '@monotykamary/schemastery'
import * as acp from '@monotykamary/dsh-acp'
import * as agentCore from '@monotykamary/dsh-agent-spine-demo'
...
} from '@monotykamary/dsh-session-persistence-jsonl'
import * as sessionCheckpointPolicy from '@monotykamary/dsh-session-checkpoint-policy'
