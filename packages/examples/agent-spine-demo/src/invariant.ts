/**
 * Package-owned invariant companion for `@monotykamary/dsh-agent-spine-demo`.
 * @module @monotykamary/dsh-agent-spine-demo/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-agent-spine-demo'
