...
import type { SaveTextSpill } from '@monotykamary/dsh-spill'
import LocalSpillStore, { encodeSegment, privateRoot, saveTextFile, sessionDir } from '@monotykamary/dsh-spill-local'
