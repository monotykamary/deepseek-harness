...
import AgentRegistry, { assembleContextFor } from '@monotykamary/dsh-agent'
import AgentLoop from '@monotykamary/dsh-agent-loop'
import InvariantRegistry from '@monotykamary/dsh-invariants'
import { describe, expect, it } from 'vitest'
import AgentPresets, { livePresetMounts, type Config } from '@monotykamary/dsh-agent-presets'
import * as AgentPresetsInvariant from '@monotykamary/dsh-agent-presets/invariant'
