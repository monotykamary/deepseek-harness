 ...
 * @module @monotykamary/dsh-agent-presets/mount
 */
...
import type { EntryTree } from '@monotykamary/cordis-plugin-loader'
import { scopeOf, scopeParentOf, type ScopeKey } from '@monotykamary/dsh-scope'
...
class PresetTree extends Include {
   ...
   * dependencies, so every `@monotykamary/dsh-*` row would fail to import. The
