 ...
 * @module @monotykamary/dsh-agent-presets
 */

import { stat } from 'node:fs/promises'
import { Context, Service } from '@monotykamary/cordis'
import z from '@monotykamary/schemastery'
import { bindScopeParent, createScope, scopeOf, type Scope, type ScopeKey, type ScopeParentBinding } from '@monotykamary/dsh-scope'
// Type-only: resolves the `agent/created` lifecycle event this service watches.
import type {} from '@monotykamary/dsh-agent'
import { settingsNamespace, type SettingsScope, type default as SettingsService } from '@monotykamary/dsh-settings'
