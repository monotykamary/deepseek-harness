/**
 * Package-owned invariant companion for `@monotykamary/dsh-agent-presets`.
 * @module @monotykamary/dsh-agent-presets/invariant
 */
...
import { leakedServices, livePresetMounts } from '@monotykamary/dsh-agent-presets'

const PACKAGE_NAME = '@monotykamary/dsh-agent-presets'
