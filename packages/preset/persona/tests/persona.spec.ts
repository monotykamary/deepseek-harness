...
import { createScope, type ScopeKey } from '@monotykamary/dsh-scope'
import { describe, expect, it } from 'vitest'
import * as Persona from '@monotykamary/dsh-persona'
import { PERSONA_SECTION } from '@monotykamary/dsh-persona'
