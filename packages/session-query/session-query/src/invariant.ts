/**
 * Package-owned invariant companion for `@monotykamary/dsh-session-query`.
 * @module @monotykamary/dsh-session-query/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-session-query'
