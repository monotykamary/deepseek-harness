...
import { foldSurface, isSurfaceEvent, snapshotSessionEvent } from '@monotykamary/dsh-session'
import type { SessionEvent, SessionId, SurfaceEvent, SurfaceEventType } from '@monotykamary/dsh-session'
