 ...
 *
 * @module @monotykamary/dsh-session-query
 */

import { Context, Service } from '@monotykamary/cordis'
import { Session, snapshotSessionEvent, type SessionId } from '@monotykamary/dsh-session'
import { foldSessionTitle } from '@monotykamary/dsh-session-title'
import type { SessionTitleSnapshot } from '@monotykamary/dsh-session-title'
import type {
