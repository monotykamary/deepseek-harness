/**
 * Package-owned invariant companion for `@monotykamary/dsh-session-query-sqlite`.
 * @module @monotykamary/dsh-session-query-sqlite/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-session-query-sqlite'
