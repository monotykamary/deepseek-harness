/**
 * Unit + real-load-path coverage for @monotykamary/dsh-tool-call-timeout-policy. The
...
import { CallId, HarnessError } from '@monotykamary/dsh-llm'
import SystemPrompt from '@monotykamary/dsh-system-prompt'
import ToolRuntime, { defineContentToolFixture, TOOL_ABORTED, type ToolExecutionInput, type PostToolDecision } from '@monotykamary/dsh-tools'
import * as timeoutPolicy from '@monotykamary/dsh-tool-call-timeout-policy'
import { TOOL_TIMEOUT } from '@monotykamary/dsh-tool-call-timeout-policy'
