/**
 * Package-owned invariant companion for `@monotykamary/dsh-repeat-tool-reminder`.
 * @module @monotykamary/dsh-repeat-tool-reminder/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-repeat-tool-reminder'
