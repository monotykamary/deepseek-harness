/**
 * Package-owned invariant companion for `@monotykamary/dsh-typert-generator`.
 * @module @monotykamary/dsh-typert-generator/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-typert-generator'
