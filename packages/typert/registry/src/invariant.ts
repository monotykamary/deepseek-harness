/**
 * Package-owned invariant companion for `@monotykamary/dsh-typert-registry`.
 * @module @monotykamary/dsh-typert-registry/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-typert-registry'
