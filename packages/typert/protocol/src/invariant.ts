/**
 * Package-owned invariant companion for `@monotykamary/dsh-typert-protocol`.
 * @module @monotykamary/dsh-typert-protocol/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-typert-protocol'
