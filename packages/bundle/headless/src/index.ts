/**
 * @monotykamary/dsh-headless — one-shot direct Agent driver. The bundle patch
 ...
 *
 * @module @monotykamary/dsh-headless
 */
...
import type { ModelSelectionRef } from '@monotykamary/dsh-agent'
...
import type {} from '@monotykamary/dsh-cmdline'
