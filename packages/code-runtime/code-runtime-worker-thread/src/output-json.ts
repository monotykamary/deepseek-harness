/** JSON string-prefix accounting for the outer-output ledger. @module @monotykamary/dsh-code-runtime-worker-thread/output-json */

import type { CodeJsonValue } from '@monotykamary/dsh-code-runtime'
