/**
 * Package-owned invariant companion for `@monotykamary/dsh-code-runtime-worker-thread`.
 * @module @monotykamary/dsh-code-runtime-worker-thread/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-code-runtime-worker-thread'
