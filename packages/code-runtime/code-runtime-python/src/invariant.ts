/**
 * Package-owned invariant companion for `@monotykamary/dsh-code-runtime-python`.
 * @module @monotykamary/dsh-code-runtime-python/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-code-runtime-python'
