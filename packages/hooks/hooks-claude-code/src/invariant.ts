/**
 * Package-owned invariant companion for `@monotykamary/dsh-hooks-claude-code`.
 * @module @monotykamary/dsh-hooks-claude-code/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-hooks-claude-code'
