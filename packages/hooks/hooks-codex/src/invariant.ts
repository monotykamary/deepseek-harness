/**
 * Package-owned invariant companion for `@monotykamary/dsh-hooks-codex`.
 * @module @monotykamary/dsh-hooks-codex/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-hooks-codex'
