/**
 * Package-owned invariant companion for `@monotykamary/dsh-client-ui-input-trigger`.
 * @module @monotykamary/dsh-client-ui-input-trigger/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-client-ui-input-trigger'
