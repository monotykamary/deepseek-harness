/**
 * Package-owned invariant companion for `@monotykamary/dsh-client-ui-message-feedback`.
 * @module @monotykamary/dsh-client-ui-message-feedback/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-client-ui-message-feedback'
