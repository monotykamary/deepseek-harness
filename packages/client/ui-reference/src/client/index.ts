 ...
 * ordering and labels.
 *
 * @module @monotykamary/dsh-client-ui-reference/client
 */
...
import { formatFileMention } from '@monotykamary/dsh-file-reference/grammar'
import type { FileReferenceCandidate } from '@monotykamary/dsh-file-reference/types'
import type { SessionReferenceMentionCandidate } from '@monotykamary/dsh-session-reference/types'
