...
import { ConversationEventRegistry } from '@monotykamary/dsh-client-runtime/src/client/conversation/event-registry.ts'
import type { GoalProjection } from '@monotykamary/dsh-goal/client'
