/**
 * Package-owned invariant companion for `@monotykamary/dsh-client-ui-goal`.
 * @module @monotykamary/dsh-client-ui-goal/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-client-ui-goal'
