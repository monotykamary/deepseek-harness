/**
 * Package-owned invariant companion for `@monotykamary/dsh-client-runtime`.
 * @module @monotykamary/dsh-client-runtime/invariant
 */
...
import type { SlotMap } from '@monotykamary/dsh-client-ui-slots'
import type { InvariantInstaller } from '@monotykamary/dsh-invariants'

const PACKAGE_NAME = '@monotykamary/dsh-client-runtime'
