/**
 * Package-owned invariant companion for `@monotykamary/dsh-client-ui-slots`.
 * @module @monotykamary/dsh-client-ui-slots/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-client-ui-slots'
