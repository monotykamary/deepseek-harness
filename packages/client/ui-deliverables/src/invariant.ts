/**
 * Package-owned invariant companion for `@monotykamary/dsh-client-ui-deliverables`.
 * @module @monotykamary/dsh-client-ui-deliverables/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-client-ui-deliverables'
