/**
 * Package-owned invariant companion for `@monotykamary/dsh-client-ui-jobs`.
 * @module @monotykamary/dsh-client-ui-jobs/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-client-ui-jobs'
