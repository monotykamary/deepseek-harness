/**
 * Package-owned invariant companion for `@monotykamary/dsh-client-ui-attachment`.
 * @module @monotykamary/dsh-client-ui-attachment/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-client-ui-attachment'
