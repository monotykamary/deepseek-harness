...
- **Composer images only** — the pure rail can present an owner-supplied video URL, but conversation intake and history still accept only images; general file cards and upload-progress states wait until the composer accepts non-image attachments.
