...
const SNAPSHOT = {
  entries: [
    { entryId: '8a1b2c3d', moduleName: '@monotykamary/cordis-plugin-hmr', enabled: true, fiberPhase: 'active' },
    ...
    { entryId: 'disabled-entry', moduleName: '@monotykamary/dsh-host-directory-picker-native', enabled: false, fiberPhase: null },
  ],
