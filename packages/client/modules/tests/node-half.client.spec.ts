...
import { renderIndexInjections, type WebServer, type WebRoute } from '@monotykamary/dsh-host-webserver'
...
const RUNTIME_ID = '@monotykamary/dsh-client-runtime'
...
describe('module graph order', () => {
  ...
  it('leaves a request no row answers to the static assembly channel', () => {
    expect(ids(orderByModuleGraph([
      entry('consumer', { external: ['@monotykamary/cordis'] }),
      entry('other'),
