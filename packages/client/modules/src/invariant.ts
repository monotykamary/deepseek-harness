/**
 * Package-owned invariant companion for `@monotykamary/dsh-client-modules`.
 * @module @monotykamary/dsh-client-modules/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-client-modules'
