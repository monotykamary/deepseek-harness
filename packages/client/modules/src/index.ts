 ...
 * @module @monotykamary/dsh-client-modules
 */
...
import type { IndexInjection } from '@monotykamary/dsh-host-webserver'
...
const CLIENT_MODULES_ID = '@monotykamary/dsh-client-modules'

/** Dynamic package whose ordinary client bundle must be registered before plugin boot starts. */
const CLIENT_RUNTIME_ID = '@monotykamary/dsh-client-runtime'
