...
import type {} from '@monotykamary/cordis'
...
/**
 * Validate an optional string-array manifest field.
 * @param subject - the manifest subject named in diagnostics.
 * @param field - the field name named in diagnostics.
