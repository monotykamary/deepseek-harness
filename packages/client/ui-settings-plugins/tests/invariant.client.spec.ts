...
import * as PluginConfigInvariant from '@monotykamary/dsh-client-ui-settings-plugins/invariant'
...
describe('invariant companion', () => {
  ...
  it('has an empty node half', async () => {
    const { apply } = await import('@monotykamary/dsh-client-ui-settings-plugins')
