/**
 * Package-owned invariant companion for `@monotykamary/dsh-client-ui-commands`.
 * @module @monotykamary/dsh-client-ui-commands/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-client-ui-commands'
