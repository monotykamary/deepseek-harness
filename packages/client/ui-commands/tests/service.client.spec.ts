...
import type { CommandResult } from '@monotykamary/dsh-commands/types'
import { createScope, scopeOf } from '@monotykamary/dsh-client-runtime/client'
import type { SessionId } from '@monotykamary/dsh-client-runtime/client'
import type { ClientSessionContext, ConsumeTokenRequest, InputTriggerPick, InputTriggerSource, SubmitImageAttachment } from '@monotykamary/dsh-client-ui-input-trigger/client'
