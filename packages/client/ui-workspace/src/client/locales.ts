...
export const zh = {
  ...
  'settled.label': '已结',
  'settled.collapsed': '已结（{n}）',
  'settled.showMore': '再显示 {n} 个',
  'empty.none': '暂无会话',
  'empty.noMatches': '无匹配结果',
  'workspace.add': '添加工作区',
  'workspace.filter.aria': '按工作区筛选会话',
  ...
  'actions.settle.aria': '结算会话',
  'actions.settle.label': '结算',
  'actions.unsettle.aria': '取消结算会话',
  'actions.snooze.aria': '稍后提醒会话',
  'actions.wake.aria': '立即唤醒会话',
  'actions.dismissWoke.aria': '关闭唤醒提示',
  'snoozed.label': '稍后',
  'snoozed.collapsed': '稍后（{n}）',
  'snooze.woke': '已唤醒',
  'menu.settle': '结算会话',
  'menu.unsettle': '取消结算',
  'menu.snooze': '稍后提醒',
...
export const en = {
  ...
  'settled.collapsed': 'Settled ({n})',
  'settled.showMore': 'Show {n} more',
  'empty.none': 'No sessions yet',
  'empty.noMatches': 'No matches',
  'workspace.add': 'Add workspace',
  'workspace.filter.aria': 'Filter sessions by workspace',
  ...
  'actions.settle.aria': 'Settle session',
  'actions.settle.label': 'Settle',
  'actions.unsettle.aria': 'Un-settle session',
  'actions.snooze.aria': 'Snooze session',
  'actions.wake.aria': 'Wake session now',
  'actions.dismissWoke.aria': 'Dismiss Woke notification',
  'snoozed.label': 'Snoozed',
  'snoozed.collapsed': 'Snoozed ({n})',
  'snooze.woke': 'Woke',
  'menu.settle': 'Settle session',
  'menu.unsettle': 'Un-settle',
  'menu.snooze': 'Snooze',
  'menu.wake': 'Wake now',
  'snooze.hour': 'In 1 hour',
  'snooze.threeHours': 'In 3 hours',
  'snooze.evening': 'This evening',
