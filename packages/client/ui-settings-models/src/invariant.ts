/**
 * Package-owned invariant companion for `@monotykamary/dsh-client-ui-settings-models`.
 * @module @monotykamary/dsh-client-ui-settings-models/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-client-ui-settings-models'
