...
import * as ModelsInvariant from '@monotykamary/dsh-client-ui-settings-models/invariant'
...
describe('invariant companion', () => {
  ...
  it('node-half apply is a no-op host placeholder', async () => {
    const { apply } = await import('@monotykamary/dsh-client-ui-settings-models')
    apply()
