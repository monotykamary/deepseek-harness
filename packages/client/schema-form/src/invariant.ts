/**
 * Package-owned invariant companion for `@monotykamary/dsh-client-schema-form`.
 * @module @monotykamary/dsh-client-schema-form/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-client-schema-form'
