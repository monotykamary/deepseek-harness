 ...
 * @param codepoint - Unicode scalar value to compare.
 * @returns Bun's differing width, or -1 when the providers agree.
 */
 ...
 * @param codepoint - Unicode scalar value to inspect.
 * @returns whether the width-2 override joins the preceding cluster.
 */
