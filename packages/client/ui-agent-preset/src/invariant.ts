/**
 * Package-owned invariant companion for `@monotykamary/dsh-client-ui-agent-preset`.
 * @module @monotykamary/dsh-client-ui-agent-preset/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-client-ui-agent-preset'
