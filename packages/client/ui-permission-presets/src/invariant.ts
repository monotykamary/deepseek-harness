/**
 * Package-owned invariant companion for `@monotykamary/dsh-client-ui-permission-presets`.
 * @module @monotykamary/dsh-client-ui-permission-presets/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-client-ui-permission-presets'
