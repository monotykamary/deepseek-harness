...
- **Graph revisions recover through a full page load** — a reconnect mismatch cannot preserve plugin-local React state because the missed ordered HMR frames are unavailable.
