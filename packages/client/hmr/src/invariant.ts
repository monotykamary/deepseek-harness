/**
 * Package-owned invariant companion for `@monotykamary/dsh-client-hmr`.
 * @module @monotykamary/dsh-client-hmr/invariant
 */

import type { Context, Fiber } from '@monotykamary/cordis'
import type { InvariantInstaller } from '@monotykamary/dsh-invariants'

const PACKAGE_NAME = '@monotykamary/dsh-client-hmr'
