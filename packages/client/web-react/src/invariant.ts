/**
 * Package-owned invariant companion for `@monotykamary/dsh-client-web-react`.
 * @module @monotykamary/dsh-client-web-react/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-client-web-react'
