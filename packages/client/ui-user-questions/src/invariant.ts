/**
 * Package-owned invariant companion for `@monotykamary/dsh-client-ui-user-questions`.
 * @module @monotykamary/dsh-client-ui-user-questions/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-client-ui-user-questions'
