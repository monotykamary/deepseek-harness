/**
 * Package-owned invariant companion for `@monotykamary/dsh-client-ui-settings-general`.
 * @module @monotykamary/dsh-client-ui-settings-general/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-client-ui-settings-general'
