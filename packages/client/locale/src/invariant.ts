/**
 * Package-owned invariant companion for `@monotykamary/dsh-client-locale`.
 * @module @monotykamary/dsh-client-locale/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-client-locale'
