...
import type { ClientContext, SettingsScope } from '@monotykamary/dsh-client-runtime/client'
...
export type { Translate, TranslateNS } from '@monotykamary/dsh-client-ui-slots'
