/**
 * Package-owned invariant companion for `@monotykamary/dsh-client-ui-layout`.
 * @module @monotykamary/dsh-client-ui-layout/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-client-ui-layout'
