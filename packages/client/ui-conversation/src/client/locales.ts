...
export const zh = {
  ...
  'workbench.inspectDescription': '检查所选工具调用的参数和结果',
  'workbench.open': '打开右侧面板',
  'workbench.close': '收起右侧面板',
  'details.title': '详情',
  'details.trajectory': '在轨迹中查看',
...
export const en = {
  ...
  'workbench.inspectDescription': 'Inspect the selected tool call arguments and result',
  'workbench.open': 'Open right panel',
  'workbench.close': 'Collapse right panel',
  'details.title': 'Details',
  'details.trajectory': 'View in Trajectory',
  ...
  'queue.moveEarlier': 'Move queued message earlier',
  'queue.moveLater': 'Move queued message later',
  ...
  'queue.moveFailed': 'Reordering failed: this message may have already started sending.',
