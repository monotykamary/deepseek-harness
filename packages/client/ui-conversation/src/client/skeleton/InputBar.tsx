...
import { AttachmentRail, DropOverlay, ImageLightbox } from '@monotykamary/dsh-client-ui-attachment'
import type { AttachmentRailItem } from '@monotykamary/dsh-client-ui-attachment'
// Type-only: the `plan` projection key merge (the TodoDock posture — the
// composer reads a host-computed value; the domain owns the key).
import type {} from '@monotykamary/dsh-plan-mode/client'
// Type-only: the `goal` projection key merge (hint disambiguation).
import type {} from '@monotykamary/dsh-goal/client'
...
import type { Translate } from '@monotykamary/dsh-client-ui-slots'
