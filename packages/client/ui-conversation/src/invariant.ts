/**
 * Package-owned invariant companion for `@monotykamary/dsh-client-ui-conversation`.
 * @module @monotykamary/dsh-client-ui-conversation/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-client-ui-conversation'
