 ...
 * not built (`bun run --filter @monotykamary/dsh-client-ui-trajectory bundle`).
 */
...
const PLUGIN_ID = '@monotykamary/dsh-client-ui-trajectory'
...
describe('tsdown client artifact', () => {
  ...
  async function loadArtifact() {
    ...
    const modules = new Map<string, unknown>([
      ...
      ['@monotykamary/dsh-client-runtime/client', await import('@monotykamary/dsh-client-runtime/client')],
      ['@monotykamary/dsh-client-ui-primitives', await import('@monotykamary/dsh-client-ui-primitives')],
    ])
  ...
  it.skipIf(code === undefined)('mounted as an object plugin, apply registers the view tab on the real ring', async () => {
    ...
    const locale = await import('@monotykamary/dsh-client-locale/client')
