...
import type { SessionMaybeProvideInfo, StoredEntry } from '@monotykamary/dsh-client-ui-slots'
import type { SessionProvideInfo, SlotRendererHost } from '@monotykamary/dsh-client-ui-renderer/client'
