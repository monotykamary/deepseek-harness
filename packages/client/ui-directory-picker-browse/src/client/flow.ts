...
import type { DirectoryListing } from '@monotykamary/dsh-client-runtime/client'
import type { Translate } from '@monotykamary/dsh-client-locale/client'
// Type-only: the owner contract of the directory-flow holes.
import type { DirectoryFlowOwnerProps } from '@monotykamary/dsh-client-ui-workspace/client'
