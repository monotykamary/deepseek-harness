/**
 * Package-owned invariant companion for `@monotykamary/dsh-client-ui-primitives`.
 * @module @monotykamary/dsh-client-ui-primitives/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-client-ui-primitives'
