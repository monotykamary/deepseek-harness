 ...
 */
export const INLINE_SAFE = /^@monotykamary\/dsh-(host-apiproxy|session|llm|tools|brand)(\/|$)/
 ...
 */
const RUNTIME_STORE_EXEMPTION = '@monotykamary/dsh-client-runtime/client'
...
function clientConfig(id: string, entry: string): UserConfig {
  return {
    ...
    plugins: [{
      ...
      // and every other @monotykamary value import is a build error — a
