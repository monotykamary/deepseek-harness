/**
 * Package-owned invariant companion for `@monotykamary/dsh-client-ui-directory-picker-native`.
 * @module @monotykamary/dsh-client-ui-directory-picker-native/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-client-ui-directory-picker-native'
