/**
 * Package-owned invariant companion for `@monotykamary/dsh-client-ui-theme`.
 * @module @monotykamary/dsh-client-ui-theme/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-client-ui-theme'
