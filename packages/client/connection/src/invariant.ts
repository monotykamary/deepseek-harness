/**
 * Package-owned invariant companion for `@monotykamary/dsh-client-connection`.
 * @module @monotykamary/dsh-client-connection/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-client-connection'
