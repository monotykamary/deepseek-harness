...
import type { InjectFace, PropsLocale, PropsRenderSlots, PropsRuntime } from '@monotykamary/dsh-client-ui-slots'
import type { ToolCallBlock } from '@monotykamary/dsh-client-runtime/client'
...
export interface ToolCallOwnerProps {
  ...
  /** Open this call in the workbench Inspect surface when available. */
