 ...
 * ({@link module:@monotykamary/dsh-tools/src/presentation}). This derivation
 ...
 * @module
 */
import type { SearchBlockProps, SearchFileGroup } from '@monotykamary/dsh-client-ui-primitives'
