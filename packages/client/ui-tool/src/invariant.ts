/**
 * Package-owned invariant companion for `@monotykamary/dsh-client-ui-tool`.
 * @module @monotykamary/dsh-client-ui-tool/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-client-ui-tool'
