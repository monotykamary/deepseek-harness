/**
 * Package-owned invariant companion for `@monotykamary/dsh-client-ui-settings`.
 * @module @monotykamary/dsh-client-ui-settings/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-client-ui-settings'
