/**
 * Package-owned invariant companion for `@monotykamary/dsh-client-ui-model-selection`.
 * @module @monotykamary/dsh-client-ui-model-selection/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-client-ui-model-selection'
