/**
 * Package-owned invariant companion for `@monotykamary/dsh-client-ui-plan`.
 * @module @monotykamary/dsh-client-ui-plan/invariant
 */
...
const PACKAGE_NAME = '@monotykamary/dsh-client-ui-plan'
