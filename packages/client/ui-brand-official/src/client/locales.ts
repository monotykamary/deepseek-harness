...
export const en = {
  ...
  factoryTitle: 'Factory task orchestration',
  factoryBody: 'Durable dependency graphs, recurring Agent work, isolated checkout lanes, and Triage turn prompts into reviewable production runs.',
...
export const zh: Record<keyof typeof en, string> = {
  ...
  factoryTitle: 'Factory 任务编排',
  factoryBody: '持久依赖图、周期性 Agent 工作、隔离 checkout lane 与 Triage，将提示词转化为可审阅的生产运行。',
