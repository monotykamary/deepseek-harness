...
const SHELL_PACKAGE = '@monotykamary/dsh-web-frontend'
...
if (isMain) {
  ...
  // the bundle gets.
  const bun = bunInvocation(['run', '--filter', SHELL_PACKAGE, 'watch'])
  spawnStage('vite build --watch', bun.command, bun.args, false)
