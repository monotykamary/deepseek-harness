...
import type { CordisCatalogModel, ServiceMethodEntry } from '@monotykamary/dsh-typert-generator'
...
function main(): void {
  ...
  const source = projector.renderRuntimeApi(clientModel(model))
    .replaceAll('@monotykamary/dsh-tool-cordis/api-catalog', '@monotykamary/dsh-cordis-client-runner/client/api-catalog')
