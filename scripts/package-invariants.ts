...
function checkManifest(
  ...
  if (owner.packageName === '@monotykamary/dsh-invariants') return
  if (manifest.peerDependencies?.['@monotykamary/dsh-invariants'] !== 'workspace:^') {
    addViolation(
      violations,
      owner.manifestPath,
      '@monotykamary/dsh-invariants must be a workspace:^ peerDependency',
    )
  }
  if (manifest.devDependencies?.['@monotykamary/dsh-invariants'] !== 'workspace:^') {
    addViolation(
      violations,
      owner.manifestPath,
      '@monotykamary/dsh-invariants must also be a workspace:^ devDependency',
    )
  }
}
...
function checkBuild(
  ...
  if (owner.packageName !== '@monotykamary/dsh-invariants'
