...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-session-title': { kind: 'indirect', reason: 'Browser-side settings row; the host title provider it opts in owns every model-facing effect.' },
  'packages/client/ui-terminal': { kind: 'none', reason: 'Browser-side human-to-PTY interface; registers nothing model-facing.' },
  'packages/terminal/terminal-web': { kind: 'none', reason: 'Browser transport for human-owned terminals; registers nothing model-facing.' },
  ...
  'packages/client/schema-form': { kind: 'none', reason: 'Browser-side schema renderer; registers nothing model-facing.' },
  'packages/client/web-react': { kind: 'none', reason: 'Browser-side React host utilities; register nothing model-facing.' },
  ...
  'packages/client/ui-files': { kind: 'none', reason: 'Browser-side workspace viewer; registers nothing model-facing.' },
  ...
  'packages/host/workspace-files': { kind: 'none', reason: 'Host-side read-only workspace projection; registers nothing model-facing.' },
