...
import {
  ...
  REGION_BEGIN,
  REGION_END,
} from '@monotykamary/dsh-typert-generator'
import type { CordisCatalogPolicy } from '@monotykamary/dsh-typert-generator'
 ...
 * The scan that enforces this list reads EVERY `declare module '@monotykamary/cordis'`
...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  identity: 'optional key (identity?: WebIdentityService): the provider is absent unless configured, so the analyzer skips optional keys by rule — docs/subsystems/web-identity.md owns the API',
  ...
  sessionDisposition: 'client-side browser Session disposition service — packages/client/ui-workspace/README.md owns the API',
 ...
 * scan reads EVERY `declare module '@monotykamary/cordis'` Events merge under
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  ToolGuard: 'tools.md',
  RunCodeLabelMode: 'tools.md',
  ToolPresentationMode: 'tools.md',
  ToolPresentationOptions: 'tools.md',
