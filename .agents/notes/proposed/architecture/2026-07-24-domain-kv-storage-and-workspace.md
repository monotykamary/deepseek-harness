...
| --- | --- | --- | --- |
| `@monotykamary/dsh-storage` | `packages/storage/storage/` | `ctx.storage` (the hub) | ✓ |
| `@monotykamary/dsh-storage-json` | `packages/storage/storage-json/` | registers backend `json` | ✓ |
| `@monotykamary/dsh-storage-sqlite` | `packages/storage/storage-sqlite/` | registers backend `sqlite` | ✓ |
| `@monotykamary/dsh-storage-domain` | `packages/storage/storage-domain/` | mounts `ctx.storage.domain` | ✓ |
| `@monotykamary/dsh-workspace` | `packages/workspace/workspace/` | `ctx.workspaceRegistry` | ✓ |
