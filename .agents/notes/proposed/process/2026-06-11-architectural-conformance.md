...
- `packages/*` (except agent-loop's own tests and examples/) must not import `@monotykamary/dsh-agent-loop`.
- No cross-package deep imports (`@monotykamary/dsh-*/src/...` paths) — public entry points only.
