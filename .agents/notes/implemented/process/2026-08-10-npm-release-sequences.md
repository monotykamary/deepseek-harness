...
|---|---|---|---|---|
| dsh | `packages/*/*` + `apps/*` (`@monotykamary/dsh` and `@monotykamary/dsh-web-frontend`) | one version for the family and the workspace root, `0.0.x` | `dsh-v<version>` | `release.yml` |
