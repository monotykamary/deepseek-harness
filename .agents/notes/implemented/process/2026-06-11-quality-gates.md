...
- Aggregate 80% coverage on `packages/*/*/src` (v8), reported without suppression directives; [deterministic revision readiness](2026-08-24-deterministic-readiness-and-proportional-coverage.md) owns the current composition.
...
- Coverage remains execution evidence rather than behavior proof; mutation testing is the proposed complementary signal (see [the mutation-testing proposal](../../proposed/testing/2026-06-11-mutation-testing.md)).
