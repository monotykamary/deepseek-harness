...
- `packages/*/*/src` 采用聚合 80% 覆盖率（v8），且不使用抑制指令；[确定性 revision 就绪](2026-08-24-deterministic-readiness-and-proportional-coverage.zh.md)负责当前组合。
...
- 覆盖率仍是执行证据而非行为证明；变异测试是拟议中的互补信号（见[变异测试提案](../../proposed/testing/2026-06-11-mutation-testing.zh.md)）。
